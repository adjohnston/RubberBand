...
var rubberband = (function (win, doc) {
  ...
  var options = { hideColumns: false, hideLines: false, showAlways: false, mobileLandscape: 640, mobilePortrait: 480, tabletLandscape: 1024, tabletPortrait: 768 }, value,
    ...
    viewToggle = function (string, boolean) {
      var a = { rbFrame: get('rb-frame'), rbOverlay: get('rb-overlay') }, i,
        viewStyling = function () {
          get('rb-frame').style.width = (win.scrollMaxY > value.winHeight) ? (options[string] + 16) + 'px' : options[string] + 'px';
          get('rb-frame').style.left = (((value.docWidth - options[string]) / 2) / value.docWidth) * 100 + '%';
        };
